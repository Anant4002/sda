...
require("./models/catalogSyncRun");
require("./models/catalogSyncNewSatellite");
require("./models/correlationRule");
require("./models/incidentGroup");
require("./models/alertCorrelation");
require("./models/incidentEventLink");
require("./models/threatScore");
